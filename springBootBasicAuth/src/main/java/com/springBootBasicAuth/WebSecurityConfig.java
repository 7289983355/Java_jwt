...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		...
		UserDetails u1 = org.springframework.security.core.userdetails.User.withUsername("tom")
				.password(encrytedPassword).roles("USER").build();
		UserDetails u2 = org.springframework.security.core.userdetails.User.withUsername("jerry")
				.password(encrytedPassword).roles("USER").build();
